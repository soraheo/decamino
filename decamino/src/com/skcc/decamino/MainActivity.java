...
public class MainActivity extends NMapActivity {
	...
	private static final String LOG_TAG = "LocationMap";
	
	private static final String API_KEY = "2dff6e2a78b8e6a49da39e7d2229db9d";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		button1.setOnClickListener(new OnClickListener() {			
			...
			public void onClick(View v) {
				...
				Intent intent = new Intent(getBaseContext(), SearchLocation.class);
				
				Bundle data = new Bundle();
				data.putString("keyword", keyword.getText().toString());
...
//	private static final int MENU_ITEM_MAP_MODE_SUB_BICYCLE = MENU_ITEM_MAP_MODE + 4;
	...
	private static final int MENU_ITEM_DECAMINO = 60;
	private static final int MENU_ITEM_DECAMINO_MENU1 = MENU_ITEM_DECAMINO + 1;
	private static final int MENU_ITEM_DECAMINO_MENU2 = MENU_ITEM_DECAMINO + 2;
	private static final int MENU_ITEM_DECAMINO_MENU3 = MENU_ITEM_DECAMINO + 3;
...
//		menuItem.setAlphabeticShortcut('a');
		...
		subMenu = menu.addSubMenu(Menu.NONE, MENU_ITEM_DECAMINO, Menu.CATEGORY_SECONDARY, "Decamino");
		subMenu.setIcon(android.R.drawable.ic_menu_more);

		menuItem = subMenu.add(0, MENU_ITEM_DECAMINO_MENU1, Menu.NONE, "여행정보");

		menuItem = subMenu.add(0, MENU_ITEM_DECAMINO_MENU2, Menu.NONE, "나의 보관함");

		menuItem = subMenu.add(0, MENU_ITEM_DECAMINO_MENU3, Menu.NONE, "T-map");
